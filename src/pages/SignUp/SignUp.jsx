...
import { imageUpload, saveOrUpdatedUserData } from '../..'
...
// .then((res)=>{
//   console.log('photo' , res.data.data.url )
 
// })
try{
  const image = await imageUpload(profileImg)
 await createUser(email, password)
 await saveOrUpdatedUserData({name, image,email})
        ...
        >
          <div className='space-y-4'>
            ...
            { errors.name?.type === 'required'  && <p className='text-red-500'>Name is required</p> }
              {
                errors.name?.type === 'maxLength' && <p className='text-red-500'>Name must be contain within 20 characters </p> 
              } 
            </div>
            {/* Image */}
            <div>
